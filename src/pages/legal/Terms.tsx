...
export default function TermsOfService() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="June 26, 2025">
      ...
      <p>
        The Service integrates third-party AI and infrastructure providers (Anthropic, Higgsfield, Arcads, Clerk, Supabase). We are not responsible for the uptime, outputs, or policies of these providers. Their terms and policies apply to the portions of the pipeline they operate.
      </p>
